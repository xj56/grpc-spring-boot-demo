...
public final class HelloGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.grpc.api.HelloGrpcProto.User,
      com.example.grpc.api.HelloGrpcProto.HelloMessage> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.example.grpc.api.HelloGrpcProto.User.class,
      responseType = com.example.grpc.api.HelloGrpcProto.HelloMessage.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.grpc.api.HelloGrpcProto.User,
      com.example.grpc.api.HelloGrpcProto.HelloMessage> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.example.grpc.api.HelloGrpcProto.User, com.example.grpc.api.HelloGrpcProto.HelloMessage> getSayHelloMethod;
      ...
      synchronized (HelloGrpc.class) {
        if ((getSayHelloMethod = HelloGrpc.getSayHelloMethod) == null) {
          HelloGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.example.grpc.api.HelloGrpcProto.User, com.example.grpc.api.HelloGrpcProto.HelloMessage>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpc.api.HelloGrpcProto.User.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpc.api.HelloGrpcProto.HelloMessage.getDefaultInstance()))
  ...
  public static abstract class HelloImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(com.example.grpc.api.HelloGrpcProto.User request,
        io.grpc.stub.StreamObserver<com.example.grpc.api.HelloGrpcProto.HelloMessage> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.example.grpc.api.HelloGrpcProto.User,
                com.example.grpc.api.HelloGrpcProto.HelloMessage>(
  ...
  public static final class HelloBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloBlockingStub> {
    ...
    /**
     */
    public com.example.grpc.api.HelloGrpcProto.HelloMessage sayHello(com.example.grpc.api.HelloGrpcProto.User request) {
  ...
  public static final class HelloFutureStub extends io.grpc.stub.AbstractFutureStub<HelloFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.grpc.api.HelloGrpcProto.HelloMessage> sayHello(
        com.example.grpc.api.HelloGrpcProto.User request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.example.grpc.api.HelloGrpcProto.User) request,
              (io.grpc.stub.StreamObserver<com.example.grpc.api.HelloGrpcProto.HelloMessage>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.grpc.api.HelloGrpcProto.getDescriptor();
    }
